            ...
            <div class="col-md-6">
                <div class="card shadow"> 
                    <div class="card-body">
                        ...
                        <form id="registroForm" action="RegistrarServlet" method="post" onsubmit="return validarFormulario();">
                            <div class="mb-3">
                            ...
                            <div class="d-grid gap-2">
                                ...
                                <button type="button" class="btn btn-danger" onclick="limpiarCampos()">Borrar</button>
                                <a href="/ventamongo/" class="btn btn-success">Volver</a>
                            </div>
                        </form>
                    </div>
                </div>
